...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm img_aloe_center">

           <center> <img class="responsive" src="vistas/img/logo/10años.png" alt=""></center>

        </div>
            <div class="col-sm garantias_inversionistas">
        ...
        <div class="col-sm formulario">
             ...
             <form id="contact-form" name="contact-form" action="mail.php" method="POST">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="md-form mb-0">
                            <input type="text" id="subject" name="subject" class="form-control" value="Necesito más información para ser un inversionista">
