 ...
 <!-- MENU RESPONSIVO MOVIL -->
    <nav class="btn-toggle">
        <div class="brand_container ">
            <a href="index"><img src="vistas/img/logo/ahlogo.png" alt="Logo Creactiv Media" class="brand"></a>
        </div>
        <div class="menu-nav">
            <div id="nav">
    ...
    <a href="https://web.whatsapp.com/send?phone=38348000&text=Hola,%20te%20contacto%20desde%20tu%20Sitio%20Web." target="_blank" class="icono_whats" >
